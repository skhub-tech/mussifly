      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
            ...
            <p>
              Experience the freedom of choice with our dual UI enginesâ€”switch between a classic Spotify-inspired layout or a modern, visual-first interface. With features like a sleep timer, crossfade playback, and smart lyrics integration, Musifly is the only music player you will ever need on your Android device.
            </p>
          </div>
        </motion.div>
      </div>
